...
$dbLink = @mysqli_connect("127.0.0.1", "root", "root", "apiDB",8889) or die(mysqli_connect_error());
mysqli_query($dbLink, "set names utf8");
mysqli_select_db($dbLink, "apiDB",8889);
...
function updateProduct($id) {
    ...
    global $dbLink;
    /*********/
    parse_str(file_get_contents('php://input'), $putData);//表單送來的資料拆解為陣列，設定為$putData
